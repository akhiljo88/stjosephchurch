...
import { Users, Save, Home, ArrowLeft, X, Upload, Image, Plus } from 'lucide-react';
  ...
  const loadFamily = async () => {
    ...
    try {
      ...
      if (familyData) {
        ...
        setCurrentPhoto(familyData.familyPhoto);
        setMembers(familyData.members || []);
        setFormData({
          headOfFamily: familyData.headOfFamily,
          contactNumber: familyData.contactNumber,
          address: familyData.address,
          numberOfMembers: familyData.numberOfMembers
        });
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100">
      ...
      <div className="pt-24 pb-12 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-red-900 mb-2 font-serif">Edit Family</h1>
              <p className="text-gray-700 font-serif">Update family details</p>
            </div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-red-900 font-serif">Update Family Information</h2>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    {displayPhoto ? 'Change Photo' : 'Choose Photo from Gallery'}
                  </button>
                </div>
              </div>
